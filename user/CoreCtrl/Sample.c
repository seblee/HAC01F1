...
//************************本模块全局变量************************
	...
	const Struct_TempratureTable tagNTCTable[NTC_TABLE_LEN] =
	{//温度放大10倍，电阻值放大100倍
		{-490,62800},{-480,59300},{-470,56000},{-460,52600},
		{-450,49200},{-440,46000},{-430,42900},{-420,40100},{-410,37900},//通过拟合得到了这10组数据
		{-400,35403},{-390,33076},{-380,30920},{-370,28922},{-360,27069},
		{-350,25348},{-340,23750},{-330,22264},{-320,20882},{-310,19595},
		{-300,18397},{-290,17280},{-280,16238},{-270,15266},{-260,14358},
		{-250,13510},{-240,12717},{-230,11976},{-220,11282},{-210,10632},
		{-200,10024},{-190,9454}, {-180,8919}, {-170,8417}, {-160,7947},
		{-150,7505}, {-140,7090}, {-130,6700}, {-120,6333}, {-110,5988},
		{-100,5664}, {-90,5358},  {-80,5071},  {-70,4801},  {-60,4547},
		{-50,4380},  {-40,4084},  {-30,3872},  {-20,3673},  {-10,3485},
		{00,3308},   {10,3142},   {20,2984},   {30,2836},   {40,2696},
		{50,2563},   {60,2438},   {70,2320},   {80,2208},   {90,2103},
		{100,2003},  {110,1908},  {120,1819},  {130,1734},  {140,1654},
		{150,1578},  {160,1505},  {170,1437},  {180,1372},  {190,1310},
		{200,1252},  {210,1196},  {220,1143},  {230,1093},  {240,1046},
		{250,1000},  {260,957},   {270,916},   {280,877},   {290,839},
		{300,804},   {310,770},   {320,738},   {330,707},   {340,678},
		{350,650},   {360,624},   {370,598},   {380,574},   {390,551},
		{400,529},   {410,508},   {420,488},   {430,469},   {440,451},
		{450,433},   {460,417},   {470,401},   {480,385},   {490,371},
		{500,357},   {510,344},   {520,331},   {530,319},   {540,307},
		{550,296},   {560,285},   {570,275},   {580,265},   {590,256},
		{600,247},   {610,238},   {620,230},   {630,222},   {640,214},
		{650,207},   {660,200},   {670,193},   {680,186},   {690,180},
		{700,174},   {710,168},   {720,163},   {730,158},   {740,152},
		{750,147},   {760,143},   {770,138},   {780,134},   {790,130},
		{800,125},   {810,122},   {820,118},   {830,114},   {840,111},
		{850,107},   {860,104},   {870,101},   {880,98},    {890,95},
		{900,92},    {910,89},    {920,86},    {930,84},    {940,81},
		{950,79},    {960,77},    {970,75},    {980,72},    {990,70},
		{1000,68},   {1010,66},   {1020,64},   {1030,63},   {1040,61},
		{1050,59}
	};
...
void CalculatePhysicalValue(UINT8 u8AnalogID)
{
	...
	switch(u8AnalogID)
	{
		...
		case ANALOGID_P2:
			...
			{	//P = (Vp - Vl) * (Ph - Pl) / (Vh - Vl)
				g_u8PSensorOutRangeFlag[u8AnalogID] = FALSE;
				l_u16Temp = (UINT16)((UINT32)(l_u16Temp - PVTYPE_VL) * (PVTYPE_PH - PVTYPE_PL) / (PVTYPE_VH - PVTYPE_VL));
			}
...
//                      / (pgm_read_word(&tagNTCTable[i-1].u16Resistance) - pgm_read_word(&tagNTCTable[i].u16Resistance));
